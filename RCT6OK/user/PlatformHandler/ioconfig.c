...
void scanOptos(void)
	{
		...
		//Neu 1 trong 3 thong so co, co dien, la co ket noi den DME
		if(LGB3Actived || LGB2Actived || LGB1Actived)
		{
				dmeTtl = 1;
			if(LGB3Actived) dmestatus.IntPriAlarm = 0;
			else dmestatus.IntPriAlarm = 1;
			
			if(LGB2Actived) dmestatus.IntMonBypass = 1;
			else dmestatus.IntMonBypass = 0;
			
			if(LGB1Actived) 
			{
				dmestatus.Tx1On = 0;//printf("DME OFF\r\n");
				dmestatus.IntMonBypass = 0;
				//dmestatus.IntPriAlarm = 0;
			}
			else dmestatus.Tx1On = 1;
		}
		//else dmeTtl = 0;
		...
		if(LGB3Actived) 
		{
			...
			//dmestatus.IntPriAlarm = 0;
			//Ko bat dc tin hieu nay vi trang thai ko thiet lap ro rang.
		}
		else 
			{
				//delay_ms(200);
			//if(LGB3Actived == 0) printf("Alarm\r\n");//DB9 -3
			}
		...
		{
			//delay_ms(200);
			//if(LGA2Actived) printf("Bypass\r\n");//dang bat che do bypass, DB9-2 
		}
		if(LGA1Actived) 
		{
			//delay_ms(200);
			//if(LGA1Actived) printf("DME OFF\r\n");//DB9 1, actived for OFF, non active for on
		}
	}
void ledON(void)
	{
