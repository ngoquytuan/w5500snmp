...
//	SPI_InitStructure.SPI_CPHA = SPI_CPHA_1Edge;	    //Data capture on the first clock edge
	...
	SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_2;//Configure SPI2 speed to be the highest
	...
	SPI_Cmd(SPI2, ENABLE); //Enable SPI peripherals
	
	/* enable DMA1 clock for SPI2*/
